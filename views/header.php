...
<nav class="navbar navbar-expand-lg navbar-light bg-light ">
            <div class="container">            
                ...
                <?php if($area=='Finanzas' || $area=='Direccion' || $usuario=='Admin' || $usuario=='DIEGE' || $usuario=='JARI'){ ?>
                    ...
                    <ul class="nav navbar-nav ms-auto">
                        <li class="nav-item dropdown">
                            <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                                <label class="fw-bold"> <?php if (isset($usuario)){ echo $usuario;} ?></label> 
                ...
                if (response.success && response.totalRegistros > 0) {
                    ...
                    if (!modalAbierto || response.totalRegistros > totalRegistrosAnterior) {
                        ...
                        response.data.forEach(registro => {
                            ...
                            contenido += '<td><a type="button" onclick="updateStatusPago(\'' + registro.Num_Operacion + '\')" class="btn btn-primary">Check</a></td>';
                            contenido += '</tr>';
                        });
