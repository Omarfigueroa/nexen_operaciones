...
if(isset($_SESSION['usuario_nexen'])){
    ...
    header('Location: ../view/operaciones.php');
}else{
            ...
            <div class="col-md-4"> 
                <div class="card my-5">
                    ...
                    <form action="../include/validacion_usuarios.php" method="POST" class="card-body cardbody-color p-lg-4">
                        <input type="hidden" name="pag_redir" value=<?php if(isset($_SESSION['pag_redir'])){echo $_SESSION['pag_redir'];unset($_SESSION['pag_redir']);}?>>
