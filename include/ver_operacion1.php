...
?>
    ...
    <body>
                            ...
                            <div class="row my-1">
                                ...
                                <div class="col">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <button type="button" class="btn btn-warning" data-bs-toggle="modal" nombre_cliente="<?php echo $nombre_cliente; ?>" id="btnEditarCliente"><i class="bi bi-pencil-square"></i></button>
                                    </div>
                                ...
                                <div class="col">
                                    ...
                                    <input type="text" id="referencia_cliente" name="referencia_cliente" oninput="quitarComillas(this)" placeholder="Introduce Referencia Cliente" class="form-control" autocomplete="off" onkeypress="return (event.charCode >= 48 && event.charCode <= 57) || (event.charCode >= 65 && event.charCode <= 90)" min="1" value="<?php echo isset($referecia_cliente) && !empty($referecia_cliente) ?  $referecia_cliente : "" ?>">
            ...
            <div class="col">
                <div class="col-12">
                    ...
                    <div class="tile">
                        <div class="tile-body">
                            ...
                            ?>
                                <button type="button" class="btn btn-success" id="verDocumentos" onclick="documentos('<?php echo $referencia_nexen; ?>','<?php echo $tipo_trafico; ?>')"><i class="bi bi-eye-fill"></i>
                ...
                <div class="col-12">
                    <div class="form-control text-center">
                        ...
                        <div class="boton-modal text-center">
                            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modal_detalle_pagos">
                        ...
                        <div class="modal-body modal-dialog-scrollable">
                            ...
                            <div class="row my-1">
                                <div class="col-sm-6">
                                    ...
                                    <select class="align-text-bottom form-control selectpicker" data-show-subtext="true" data-live-search="true" id="proveedor_fact" name="proveedor_fact" onchange="cambiarProveedor(this);">
                                ...
                                <div class="col-sm-4 ">
                                    ...
                                    <input type="text" class="align-text-bottom form-control" id="modal_pais_origen" name="num_factura" placeholder="Introduce país de origen" required>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-12">
                            ...
                            <div class="row my-1">
                                <div class="col-sm-4">
                                    ...
                                    <input type="text" class="align-text-bottom form-control" id="modal_num_factura" name="num_factura" placeholder="Introduce # factura" required>
                                </div>
                                <div class="col-sm-4">
                                    <h6 class="text-center">Fecha de Factura</h6>
                                    <input type="date" class="align-text-bottom form-control" id="modal_fecha_factura" name="fecha_factura" required value="">
                                </div>
                                <div class="col-sm-2 ">
                            ...
                            <div class="partidas">
                                <div class="row my-1">
                                    <div class="col-sm-6">
                                        ...
                                        <textarea rows="" class="align-text-bottom form-control" id="desc_factura" name="desc_factura" cols="" required></textarea>
                                        <!-- <input type="tex"  class="align-text-bottom form-control"> -->
                                    </div>
                                    <div class="col-sm-6">
                                        <h6 class="text-center">Cove Description (English)</h6>
                                        <textarea rows="" class="align-text-bottom form-control" id="desc_factura_i" name="desc_factura_i" cols="" required></textarea>
                                        <!-- <input type="tex"  class="align-text-bottom form-control"> -->
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-sm-3 ">
                                        ...
                                        <input type="number" class="align-text-bottom form-control" id="modal_cantidad" name="modal_valor_factura" placeholder="Introduce cantidad" pattern="^[0-9]+">
                                    </div>
                                    <div class="col-sm-2">
                                    ...
                                    <div class="col-sm-3 ">
                                        ...
                                        <div class="input-group">
                                            <input type="text" class="form-control" id="precio_unitario" name="precio_unitario" placeholder="Introduce el Precio Unitario 00.00" disabled>
                                    ...
                                    <div class="col-sm-2 ">
                                        ...
                                        <input type="number" class="align-text-bottom form-control" id="precio_total" name="precio_total" placeholder="Total">
                                    </div>
                                </div>
                                <div class="row pt-2 pb-2 justify-content-end">
                                    <div class="col-sm-2">
                                        <h6 class="text-center">Mark</h6>
                                        <input type="text" class="align-text-bottom form-control" id="modal_mark" name="modal_mark" placeholder="Mark N/M">
                                    </div>
                                    <div class="col-sm-2">
                                        <h6 class="text-center">Peso Bruto</h6>
                                        <input type="number" min="0" class="align-text-bottom form-control" id="modal_peso_bruto" name="peso_bruto" placeholder="Bruto">
                                    </div>
                                    <div class="col-sm-2">
                                        <h6 class="text-center">Peso Neto</h6>
                                        <input type="number" min="0" class="align-text-bottom form-control" id="modal_peso_neto" name="peso_neto" placeholder="Neto">
                                    </div>
                                </div>
                            </div>
                            <!-- </div> -->
                            ...
                            <div class="embed-responsive">
                                <div class="container">
                                    <table class="table w-100 p-3 table-responsive table-scrollable" id="tablaFacturas">
                                        <thead>
                                            <tr>
                                                <th scope="col"># FACTURA</th>
        ...
        <div class="modal fade" id="modalEditarFacturas" tabindex="-1" aria-labelledby="modalEditarFacturas" aria-hidden="true">
            <div class="modal-dialog modal-xl">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <div class="modal-body table-responsive">
                        ...
                        <div class="form_facturas_edit">
                            <div class="row my-1">
                                <div class="col-sm-8 ">
                                    <h6 class="text-center">Proveedor</h6>
                                    <select class="align-text-bottom form-control" id="proveedor_fact_edit" name="proveedor_fact_edit" onchange="cambiarProveedorEdit(this);">
                                        <option value="">Selecciona una opción</option>
                                        <?php
                                        foreach ($result_cat_proveedor as $valores) :
                                            echo '<option domicilio="' . $valores['domicilio'] . '" taxid="' . $valores["codigo"] . '" value="' . $valores["proveedor"] . '">' . $valores["proveedor"] . '</option>';
                                ...
                                <div class="col-sm-4 ">
                                    <h6 class="text-center">País de origen</h6>
                                    <input type="text" class="align-text-bottom form-control" id="modal_pais_origen_edit" name="num_factura" placeholder="Introduce país de origen" required>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-12">
                            ...
                            <div class="row my-1">
                                ...
                                <div class="col-sm-4">
                                    <h6 class="text-center">Fecha de Factura</h6>
                                    <input type="date" class="align-text-bottom form-control" id="modal_fecha_factura_edit" name="fecha_factura" required value="">
                                </div>
                                <div class="col-sm-2 ">
                                    <h6 class="text-center">TAX-ID</h6>
                            ...
                            <div class="row my-1">
                                <div class="col">
                                    <h6 class="text-center">Domicilio Fiscal Operador</h6>
                                    <input type="text" class="align-text-bottom form-control" id="modal_domicilio_operador_edit" name="modal_domicilio_operador" placeholder="" disabled value="">
                                </div>
                            </div>
                        </div>
                        <div class="partidas_edit">
                            <div class="row my-1">
                                <div class="col-sm-6">
                                    <h6 class="text-center">Descripción Cove (Español)</h6>
                                    <textarea rows="" class="align-text-bottom form-control" id="desc_factura_edit" name="desc_factura" cols="" required></textarea>
                                    <!-- <input type="tex"  class="align-text-bottom form-control"> -->
                                </div>
                                <div class="col-sm-6">
                                    <h6 class="text-center">Cove Description (English)</h6>
                                    <textarea rows="" class="align-text-bottom form-control" id="desc_factura_i_edit" name="desc_factura_i" cols="" required></textarea>
                                    <!-- <input type="tex"  class="align-text-bottom form-control"> -->
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-3 ">
                                    <h6 class="text-center">Cantidad</h6>
                                    <input type="number" class="align-text-bottom form-control" id="modal_cantidad_edit" name="modal_valor_factura" placeholder="Introduce cantidad" pattern="^[0-9]+">
                                </div>
                                <div class="col-sm-2">
                                    <h6 class="text-center">Medida</h6>
                                ...
                                <div class="col-sm-3 ">
                                    <h6 class="text-center">Precio Unitario</h6>
                                    <input type="number" class="align-text-bottom form-control" id="precio_unitario_edit" name="precio_unitario" placeholder="Introduce el Precio Unitario 00.00" disabled>
                                </div>
                                <div class="col-sm-2 ">
                                    <h6 class="text-center">Moneda</h6>
                                    <select class="form-control" id="modal_moneda_edit" name="modal_moneda">
                                        <?php
                                        try {
                                            // Consulta los datos de la tabla medidas
                                            $stmt = $conn_bd->prepare("SELECT TOP (1000) * FROM [dbo].[MONEDAS]");
                                ...
                                <div class="col-sm-2 ">
                                    <h6 class="text-center">Precio Total</h6>
                                    <input type="number" class="align-text-bottom form-control" id="precio_total_edit" name="precio_total" placeholder="Total">
                                </div>
                            </div>
                            <div class="row pt-2 pb-2 justify-content-end">
                                <div class="col-sm-2">
                                    <h6 class="text-center">Mark</h6>
                                    <input type="text" class="align-text-bottom form-control" id="modal_mark_edit" name="modal_mark" placeholder="Mark N/M">
                                </div>
                                <div class="col-sm-2">
                                    <h6 class="text-center">Peso Bruto</h6>
                                    <input type="number" min="0" class="align-text-bottom form-control" id="modal_peso_bruto_edit" name="peso_bruto" placeholder="Bruto">
                                </div>
                                <div class="col-sm-2">
                                    <h6 class="text-center">Peso Neto</h6>
                                    <input type="number" min="0" class="align-text-bottom form-control" id="modal_peso_neto_edit" name="peso_neto" placeholder="Neto">
                                </div>
                            </div>
                        </div>
                        <!-- </div> -->
                        ...
                        <br>
                        <div class="embed-responsive">
                            <div class="container-fluid tabla-partidas">
        ...
        <div class="modal fade" id="confirmDeleteModal" tabindex="-1" role="dialog" aria-labelledby="confirmDeleteModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p>Recuerda que al borrar la factura tambien borraras sus partidas. </p>
            ...
            <div class=" modal-dialog ">
                <div class="modal-content text-center">
                    ...
                    <div class="modal-body modal-dialog-scrollable">
                        ...
                        <label class="display-5">Proveedor</label><br><br>
                        <label class="align-text-bottom form-label">Tax-ID</label>
                        <input type="text" class="align-text-bottom  form-control" pattern="[a-zA-Z0-9-]+" onblur="validarTextNumber(this)" id="editar_tax_id" name="editar_tax_id" placeholder="Introduce Código TAX-ID" required disabled>
                        <label class="align-text-bottom form-label">Proveedor</label>
                    ...
                    <form method="POST" id="SolicitudPago" enctype="multipart/form-data">
                        <div class="form-table-consulta">
                            ...
                            <div class="row my-1">
                                ...
                                <div class="col-sm-12">
                                    <div class="form-floating  mb-3">
                                        <select class="align-text-bottom form-control selectpicker" onchange="mostrar_datos_cuenta(this.value)" id="select_Cuenta" data-live-search="true">
                                            <?php
                                            echo '<option value="">Selecciona una opción</option>';
                                            foreach ($result_cuenta_destino as $valores) :
                                                echo '<option value="' . $valores["Id_Cuenta"] . '">' . $valores["Cuenta_Destino"] . ' ' . $valores["Banco"] . '</option>';
                                            endforeach; ?>
                                        </select>
                        ...
                        <div class="row my-1">
                            ...
                            <div class="col-sm-10 text-center">
                                <button type="button" id="cancelar_detalle_pago" onclick="CloseDetalle()" class="btn btn-lg btn-danger">Cancelar</button>
        ...
        <!-- FIN MODAL SUBIR DOCUMENTO DE SOLICITUD DE PAGO -->

        <!-- Modal  detalle de Pagos -->
        <div class="modal fade" id="modal_detalle_pagos" tabindex="-1" role="dialog" aria-labelledby="modal_detalle_pagos" aria-hidden="true">
            <div class="modal-dialog modal-xl">
                <div class="modal-content text-center ">
                    <div class="modal-header bg-primary text-white  text-center ">
                        <label class="modal-title  text-wrap" style="width: 50rem;" id="exampleModalLabel">DETALLE DE
                    ...
                    <form method="POST">
                        <table id="data_table" class="table">
                            ...
                            <tbody>
                                <?php
                                $select_det_pago  = "SELECT * FROM [dbo].[FK_Solicitud_Pago] WHERE REFERENCIA_NEXEN = '$referencia_nexen '";
                                $detalle_pago = $conn_bd->prepare($select_det_pago);
                                $detalle_pago->execute();
                                $results_detalle_pago = $detalle_pago->fetchAll(PDO::FETCH_ASSOC);

                                foreach ($results_detalle_pago as $detalle) : ?>

                                    <tr>
                                        <td class=""><?php echo $detalle['Referencia_Nexen']; ?></td>
                                        <td class=""><?php echo $detalle['Cliente']; ?></td>
                                        <td class=""><?php echo $detalle['Operador']; ?></td>
                                        <td class=""><?php echo $detalle['Concepto']; ?></td>
                                        <td class=""><?php echo $detalle['Tipo_Solicitud']; ?></td>
                                        <td class=""><?php echo $detalle['Monto']; ?></td>
                                        <td class=""><?php echo $detalle['Usuario']; ?></td>
                                        <td class=""><?php echo $detalle['Estatus']; ?></td>
                                        <td class=""><?php echo $detalle['Fechope']; ?></td>
                                        <td class=""><?php $tipo_solicitud_pago = $detalle['Tipo_Solicitud'];
                                                        $id = $detalle['Num_Operacion'];

                                                        ?>
                                            <!-- <button type="submit" class="btn btn-lg btn-danger" onclick="this.form.action ='autorizar_pago.php?id=<?php echo $id ?>'"><i class="bi bi-check-circle-fill"></i></button>
                                                        </button>  -->
                                            <a href="../include/pdf_pagos_refac.php?id=<?php echo $id ?>" class="btn btn-lg btn-info">
        ...
        <script src="../utils/functions_checkSolicitudPago.js"></script>
...
<script src="../utils/functions_solicitud_pagos.js"></script>
