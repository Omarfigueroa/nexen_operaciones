                ...
                <td  colspan="2">
                    <table id="conceptos" style="width: 100%;" align="center">
                        ...
                        <tr>
                            ...
                            <th style="text-align:center;"><FONT SIZE=2>N.W (KGS)</FONT></th>
                            <th style="text-align:center;"><FONT SIZE=2>G.W (KGS)</FONT></th>
                        </tr>
                        <?php 
                        ...
                        <tr>
                            ...
                            <td style="width: 12%;;text-align:center;"><FONT SIZE=1><?php echo $conc['Peso_Neto']; ?></FONT></td>
                            <td style="width: 12%;text-align:right;"><FONT SIZE=1><?php echo $conc['Peso_Bruto']; ?></FONT></td>
                        </tr>
                        <?php
                            }
                        ?>
