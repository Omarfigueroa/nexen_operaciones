                                    ...
                                    if(isset($_FILES['file']) && $_FILES['file']['error'] === UPLOAD_ERR_OK) {
                                        ...
                                        if($tipoArchivo === ".pdf" || $tipoArchivo === ".PDF" 
                                            ...
                                            ||$tipoArchivo == ".png" || $tipoArchivo == ".PNG"){
                                                ...
                                                $stmt->bindParam(1, $concepto_sp);
                                                $stmt->bindParam(2, $referencia_nexen_sp);
                                                $stmt->bindParam(3, $num_economico);
                                                $stmt->bindParam(4, $fechaOpe);
                                                $stmt->bindParam(5, $hora);
                                                $stmt->bindParam(6, $estatus);
                                                $stmt->bindParam(7, $name_usuario);
                                                $stmt->bindParam(8, $id_pago);
                                                $stmt->bindParam(9, $dest_path);
                                                $stmt->execute();
                                    ...
                                    if(isset($_FILES['file']) && $_FILES['file']['error'] === UPLOAD_ERR_OK) {
                                        ...
                                        if($tipoArchivo === ".pdf" || $tipoArchivo === ".PDF"
                                            ...
                                            ||$tipoArchivo == ".png" || $tipoArchivo == ".PNG"){
                                                ...
                                                $stmt->bindParam(1, $concepto_sp);
                                                $stmt->bindParam(2, $referencia_nexen_sp);
                                                $stmt->bindParam(3, $numero_pedimento);
                                                $stmt->bindParam(4, $fechaOpe);
                                                $stmt->bindParam(5, $hora);
                                                $stmt->bindParam(6, $estatus);
                                                $stmt->bindParam(7, $name_usuario);
