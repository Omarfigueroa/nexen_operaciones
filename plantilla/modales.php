            ...
            <div class="modal-dialog modal-xl text-center">
                <div class="modal-content text-center">
                    <div class="modal-body modal-dialog-scrollable">
                        ...
                        <div class="row my-1">
                            <div class="col-sm-6">
                                ...
                                <div class="selectprueba">
                                    <select class="align-text-bottom form-control selectpicker validSelect"
                                        data-show-subtext="true" data-live-search="true" id="proveedor_fact"
                                        name="proveedor_fact" onchange="cambiarProveedor(this);">
                            ...
                            <div class="col-sm-2">
                                ...
                                <button id="btnEditarProveedor" class="btn btn-sm btn-warning" data-bs-toggle="modal"
                                    data-bs-target="#modal_editar_proveedor" disabled><i class="bi bi-pen"></i></button>
                            </div>
                            <div class="col-sm-4 ">
                                <h6 class="text-center">País de origen</h6>
                                <input type="text" class="align-text-bottom form-control validText"
                                    id="modal_pais_origen" oninput="quitarAcentosYComillas(this)" name="num_factura"
                                    placeholder="Introduce país de origen" required>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-12">
                                <h6 class="text-center">Domicilio proveedor</h6>
                                <input type="text" class="align-text-bottom form-control" id="modal_domicilio_proveedor"
                                    name="modal_domicilio_proveedor" placeholder="Introduce proveedor" required
                                    disabled>
                            </div>
                        </div>
                        <br>
                        <div class="row my-1">
                            <div class="col-sm-4">
                                ...
                                <input type="text" class="align-text-bottom form-control validFactura"
                                    id="modal_num_factura" oninput="quitarAcentosYComillas(this)" name="num_factura"
                                    placeholder="Introduce # factura" required>
                            </div>
                            <div class="col-sm-4 validando">
                                <h6 class="text-center">Fecha de Factura</h6>
                                <input type="date" class="align-text-bottom form-control validDate"
                                    id="modal_fecha_factura" name="fecha_factura" required value="">
                            </div>
                            <div class="col-sm-2 ">
                                <h6 class="text-center">TAX-ID</h6>
                                <input type="text" class="align-text-bottom form-control" name="tax_id" id="tax_id"
                                    value="" required disabled placeholder="Escoger proveedor">
                            </div>
                            <div class="col-sm-2">
                                <h6 class="text-center">Incoterms</h6>
                                <select class="align-text-bottom form-control selectpicker validSelect" id="incoterms"
                                    name="incoterms" data-live-search="true">
                                    <option value="" selected disabled>Selecciona una opción</option>
                                </select>
                            </div>
                        ...
                        <div class="row my-1">
                            <div class="col-sm-8">
                                ...
                                <input type="text" class="form-control" value="" id="modal_nombre_operador"
                                    name="modal_nombre_operador" disabled>
                            </div>
                            <div class="col-sm-4">
                        ...
                        <div class="partidas">
                            <div class="row my-1">
                                <div class="col-sm-6 validando">
                                    ...
                                    <textarea rows="" class="align-text-bottom form-control validDescription"
                                        id="desc_factura" oninput="quitarAcentosYComillas(this)" name="desc_factura"
                                ...
                                <div class="col-sm-6 validando">
                                    ...
                                    <textarea rows="" class="align-text-bottom form-control validDescription"
                                        id="desc_factura_i" oninput="quitarAcentosYComillas(this)" name="desc_factura_i"
                                        cols="" required></textarea>
                                    <!-- <input type="tex"  class="align-text-bottom form-control"> -->
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-3 validando">
                                    ...
                                    <input type="text" class="align-text-bottom form-control validNumber"
                                        id="modal_cantidad" name="modal_valor_factura" placeholder="Introduce cantidad"
                                        pattern="^[0-9]+">
                                </div>
                                <div class="col-sm-2 validando">
                                    <h6 class="text-center">Medida</h6>
                                    <select class="align-text-bottom form-control selectpicker validSelect" id="medida"
                                        name="medida" data-live-search="true">
                                        <option value="" selected disabled>Selecciona una opción</option>
                                    </select>
                                </div>
                                <div class="col-sm-3 ">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control validNumber" id="precio_unitario"
                                            name="precio_unitario" placeholder="Introduce el Precio Unitario 00.00"
                                            hidden>
                                        <input type="text" class="form-control validNumber" id="precio_fishing"
                                            name="precio_fishing" placeholder="Introduce el Precio Unitario 00.00"
                                            disabled>
                                    </div>
                                </div>
                                <div class="col-sm-2 validando">
                                    ...
                                    <select class="align-text-bottom form-control selectpicker validSelect"
                                        id="modal_moneda" name="modal_moneda" data-live-search="true">
                                        <option value="" selected disabled>Selecciona una opción</option>
                                    </select>
                                </div>
                                <div class="col-sm-2 validando">
                                    ...
                                    <input type="text" class="align-text-bottom form-control validNumber"
                                        id="precio_total" name="precio_total" placeholder="Total">
                                </div>
                            </div>
                            <div class="row pt-2 pb-2 justify-content-end">
                                <div class="col-sm-2 validando">
                                    <h6 class="text-center">Mark</h6>
                                    <input type="text" class="align-text-bottom form-control validMark" id="modal_mark"
                                        oninput="quitarAcentosYComillas(this)" name="modal_mark" placeholder="Mark N/M">
                                </div>
                                <div class="col-sm-2 validando">
                                    <h6 class="text-center">Peso Bruto</h6>
                                    <input type="text" min="0" class="align-text-bottom form-control validNumber"
                                        id="modal_peso_bruto" name="peso_bruto" placeholder="Bruto">
                                </div>
                                <div class="col-sm-2 validando">
                                    <h6 class="text-center">Peso Neto</h6>
                                    <input type="text" min="0" class="align-text-bottom form-control validNumber"
                                        id="modal_peso_neto" name="peso_neto" placeholder="Neto">
                                </div>
                            </div>
                        </div>
                        <!-- </div> -->
                        ...
                        <div class="embed-responsive card">
                            <div class="container table-responsive card-body">
                                <table
                                    class="table w-100 p-3 table-responsive table-scrollable table-striped table-hover"
                                    id="tablaFacturas">
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="col">NUMERODE FACTURA</th>
                                            <th scope="col">FECHA FACTURA</th>
                                            <th scope="col">ICOTERMS</th>
                                    ...
                                    <tfoot>
                                        <tr>
                                            ...
                                            <th scope="col" id="total_cantidad" value="0"></th>
                                            <th scope="row"></th>
                                            <th scope="col" id="total_peso_unitario" value="0"></th>
                                            <th scope="row"></th>
                                            <th scope="col" id="totalgeneral" value="0">0</th>
                                            <th scope="col" id="totalpesobruto" value="0">0</th>
                                            <th scope="col" id="totalpesoneto" value="0">0</th>
                                            <th scope="row"></th>
                                            <th scope="row"></th>
                                        </tr>
                                    </tfoot>
                    ...
                    <div class="modal-footer ">
                        ...
                        <button id="btnGuardarFacturas" type="button" class="btn btn-lg btn-success"
                           >
                            <span id="spinner_insert" class="spinner-border spinner-border-sm d-none" role="status"
