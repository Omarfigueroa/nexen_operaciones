        ...
        <div class="modal fade" id="modalCargarFacturas" aria-hidden="true" aria-labelledby="exampleModalToggleLabel" tabindex="-1">
            <div class="modal-dialog modal-xl text-center">
                <div class="modal-content text-center">
                    ...
                    <div class="modal-footer ">
                        <button type="button" id="closeFacturas" class="btn btn-lg btn-danger" data-bs-dismiss="modal">Cancelar</button>
        ...
        <!-- MODAL FACTURA DETALLES PARA VISUALIZAR LA TABLA CON PARTIDAS DE LA FACTURA -->
